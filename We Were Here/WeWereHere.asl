...
state("We Were Here"){
    ...
    int currentPuzzleIndex: "GameAssembly.dll", 0x4079298, 0xB8, 0xBB0, 0x20, 0x28;
    ...
    bool isTheaterFinished: "GameAssembly.dll", 0x4079298, 0xA0, 0xDA0, 0x20, 0x10, 0x148, 0X10, 0x50, 0x20, 0x29;
}
